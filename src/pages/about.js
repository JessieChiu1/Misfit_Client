    ...
    return (
        <>
            ...
            <div className={styles.container}>
                ...
                <Text size={500}>Discover a world of style and self-expression at Misfit &ndash; a platform crafted exclusively for the transgender community. Here, we invite you to share, inspire, and celebrate your individual fashion journey. At Misfit, we firmly believe that everyone deserves a space to express their authentic selves, particularly when it comes to personal style.</Text>
                <br/>
